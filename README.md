...
The `incompatibilities` list contains an object that tells the program what layers are incompatible with what. In the above configuration, A Blue Background `layer` will _never_ be generated with Python Logo 2.
...
- _This is an optional step, and can be exited safely using `enter` or `control + c`._
...
`python3 /Users/ryan.margono/Desktop/nft-generator-py/index.py`
